<template>
	<div class="fakerUser">
		<div class="card">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control" id="location" v-model="user.country">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="catg">Catg</label>
              <select class="form-control" id="catg" v-model="user.catg">
...
<script>
	export default {
		...
		methods:{
			store() {
				const vm = this;
				axios.post('/api/admin/faker/user',vm.user).then(response => {
					location.reload();
				}).catch(err => {
					console.log(err)
				});	
